// XE Common_HLSL.fx
// MGE XE 0.16.0
// Shared structures and functions - HLSL Version
...
shared float4 vertexBlendState;  // Changed from int to float4
...
sampler sampDepthPoint = sampler_state { 
    texture = <tex3>; 
    minfilter = point; 
    magfilter = point; 
    mipfilter = none; 
