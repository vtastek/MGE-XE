...
#line 38 "C:/projects/mgexe/MGE-XE/mgeHost64/shaders/FSL/shadowcaster.frag.fsl"
...
void PS_MAIN( VSOutput In )
{
    ...
    float owner = In.MatEmissive.y;
    float bakeSlot= gFrameData.atlasDbg.w;
