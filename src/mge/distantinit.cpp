...
D3DXHANDLE DistantLand::ehReflectionView;
...
D3DXHANDLE DistantLand::ehA2CSharpnessClose;
D3DXHANDLE DistantLand::ehA2CSharpnessFar;
...
bool DistantLand::initShader() {
    ...
    ehReflectionView = effect->GetParameterByName(0, "reflectionView");
    ehReflectionProj = effect->GetParameterByName(0, "reflectionProj");
    ehReflectionWaterLevel = effect->GetParameterByName(0, "reflectionWaterLevel");
    ...
    ehA2CSharpnessClose = effect->GetParameterByName(0, "a2cSharpnessClose");
    ehA2CSharpnessFar = effect->GetParameterByName(0, "a2cSharpnessFar");
