...
const iniSetting iniSettings[] = {
    ...
    {&Configuration.EnableDebugInterfaceKey, t_bool, 1, siniMisc, "Enable Debug Interface Key", False, &dictBool, DICTONLY, 0, 0},
    ...
    {&Configuration.PCF.Bias, t_float, 1, siniRendState, "PCF Depth Bias", "0.0", NULL, MINMAX, 0.0, 0.01},
    ...
    {&Configuration.PCF.CloseSlopeBias, t_float, 1, siniRendState, "PCF Close Slope Bias", "0.0", NULL, MINMAX, 0.0, 0.01},
    {&Configuration.PCF.CloseTerrainBias, t_float, 1, siniRendState, "PCF Close Terrain Bias", "0.002", NULL, MINMAX, 0.0, 0.02},

    // HLSL-pipeline unified-look exposure scalar
    {&Configuration.IntensityScalar, t_float, 1, siniRendState, "Intensity Scalar", "1.0", NULL, MINMAX, 0.1, 10.0},
};
