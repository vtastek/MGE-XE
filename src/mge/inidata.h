...
const iniSetting iniSettings[] = {
    ...
    {&Configuration.UseSharedMemory, t_bool, 1, siniMisc, "Use Shared Memory", True, &dictBool, DICTONLY, 0, 0},
    {&Configuration.UseOcclusionCulling, t_bool, 1, siniMisc, "Use Occlusion Culling", True, &dictBool, DICTONLY, 0, 0},
    {&Configuration.UseHostOcclusionCull, t_bool, 1, siniMisc, "Use Host Occlusion Cull", True, &dictBool, DICTONLY, 0, 0},
    ...
    {&Configuration.UseSceneGraphSnapshot, t_bool, 1, siniMisc, "Use Scene Graph Snapshot", True, &dictBool, DICTONLY, 0, 0},
    {&Configuration.UseAsyncSceneGraphWalk, t_bool, 1, siniMisc, "Use Async Scene Graph Walk", True, &dictBool, DICTONLY, 0, 0},
    ...
    {&Configuration.ForgeEngineCullTakeover, t_bool, 1, siniMisc, "Forge Engine Cull Takeover", False, &dictBool, DICTONLY, 0, 0},
    ...
    {&Configuration.DL.ShadowNearStaticRadius, t_float, 1, siniDL, "Shadow Near Static Radius", "0", NULL, MINMAX, 0, 8192},
